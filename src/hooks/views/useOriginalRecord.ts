...
const useOriginalRecord = <M extends IACeleV2.Data.ModelName>() => {
    ...
    const { recordId, originalRecord, updateOriginalRecord, deleteOriginalRecord, reload } = useContext<IACeleV2.Context.ViewContext.OriginalRecord<M>>(OriginalRecordContext);
