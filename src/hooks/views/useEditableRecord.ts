...
const useEditableRecord = <M extends IACeleV2.Data.ModelName>() => {
    ...
    const { editableRecord, existingChanges, undoChangesInEditableRecord, updateEditableRecordField, saveChanges, executeAction, createMode } = useContext<IACeleV2.Context.View.EditableRecord<M>>(EditableRecordContext);
